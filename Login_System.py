...
def register():
	...
	if registered:
		...
		ok_btn = Button(failed_register_window, text="Try Again", width="20" ,command = lambda :failed_register_window.destroy())
		ok_btn.pack(pady=20)
	else:
		...
		ok_btn = Button(successfull_register_window, text="OK", width="20" ,command = lambda :successfull_register_window.destroy())
		ok_btn.pack(pady=20)
...
def login_verify():
	...
	login = False
	for line in open("credentials.txt","r").readline():
		login_info =line.split()
